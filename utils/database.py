...
class DataBase:
    def __init__(self, posts_path, users_path):
        ...
        self.case_posts = json.load(open('./data/post_highlight.json', 'r', encoding='utf-8'))
        self.case_clusters = json.load(open('./data/cluster.json', 'r', encoding='utf-8'))
        self.case_posts_other = json.load(open('./data/post_others.json', 'r', encoding='utf-8'))
